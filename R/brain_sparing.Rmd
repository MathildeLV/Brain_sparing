...
laus4_long_z_sex <- laus4 %>%
  ...
  mutate(Syphilis_2=recode(Syphilis_2, "positive"= "yes"))
...
plot_flu_BW_HC_sex_zscore <- ggplot(laus4_long_z_sex, aes(x = Flu_in_pregn_and_in_pandemic, y = Value, fill = Flu_in_pregn_and_in_pandemic)) +
  ...
  facet_grid(~Variable, scales = "fixed", labeller = labeller(Variable = c("Birthweight_Z_sex2" = "Birth weight", "head_circ_perturb_Z_sex2" = "Head circumference")), space = "free_x") +
  theme_bw() +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", linewidth = 0.7, colour = "#0072B2") +
...
infections_BW_HC_sex_Z_score <- egg::ggarrange(plot_flu_BW_HC_sex_zscore, 
                                    ...
                                    ncol = 2, nrow = 1) 
# save 13*5.5
ggsave("outputs/graphs/brain_sparing/infections_head_circ_birthweight_sexzscore.pdf", infections_BW_HC_sex_Z_score, width = 14, height = 5.5, units = "in", device = "pdf")
```
...
plot_syph_BW_HC_sex_zscore_stillbirth <- ggplot(laus4_long_z_sex, aes(x = Syphilis_2, y = Value, fill = Syphilis_2)) +
  ...
  facet_grid(Variable~stillbirth, scales = "fixed", labeller = labeller(Variable = c("Birthweight_Z_sex2" = "Birth weight", "head_circ_perturb_Z_sex2" = "Head circumference")), space = "free_x") +
  theme_bw() +
  custom_theme()+
  labs(x = "Syphilis", y = "sex Z-score") +
  scale_fill_manual(values = c("no" = "gainsboro", "yes" = "lightcyan2")) +
...
ggsave("outputs/graphs/brain_sparing/infections_head_circ_birthweight_stillbirth_sexzscore.pdf", infections_BW_HC_sex_Z_score_stillbirth, width = 16.25, height = 7.25, units = "in", device = "pdf")
```
